...
_PRIVATE_STATE_RE = re.compile(
    r"(?i)(?:[\"']?)(?:familiarity|trust|comfort|closeness|tension|relationship_stage|intimacy_ceiling|granted_intimacy|intimacy_request|nickname_permission|home_access|home_history_allowed|current_home_access|world_state_available|world_state_status|world_state_meaning|state_status|action_permissions|physical_contact|nickname_use|has_authorized_history|claiming_home_history|permission_scope|phase_basis|wake_cause)(?:[\"']?)\s*[:=]"
)
