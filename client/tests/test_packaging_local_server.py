...
def test_wheel_installs_every_module_needed_to_import_local_server(
    ...
    assert "runtime/private_world/reducer.py" in packaged_paths
    assert "runtime/private_world/service.py" in packaged_paths
    ...
    _run(
        [
            ...
            "import private_world_port, private_world_commands, private_world_ledger, private_world_reducer, private_world_service; "
            "import runtime.private_world.port, runtime.private_world.commands, runtime.private_world.ledger, runtime.private_world.reducer, runtime.private_world.service; "
            ...
            "assert private_world_reducer is runtime.private_world.reducer; "
            "assert private_world_service is runtime.private_world.service; "
