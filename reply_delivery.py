"""Non-spoken delivery planning for ordinary video replies.
...
_ORDINARY_VIDEO_CONSTRAINT = (
    ...
    "正文去除空白后的总字符数严格为180到200，汉字、标点、数字和字母都计入，目标为185个总字符；"
    "输出前必须自行计数，"
    "若不在范围内先在内部删改，绝不输出范围外正文。内容应先回应对方当下的感受，再给出清晰判断，最后自然收束；"
