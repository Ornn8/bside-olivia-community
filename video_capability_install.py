...
_RUNTIME_ENVIRONMENT_KEYS = {
    ...
    "OLIVIA_ACE_REFERENCE", "OLIVIA_ACE_ASR_MODEL", "OLIVIA_ACE_ORIGINAL_LORA",
    "OLIVIA_FFMPEG_EXE",
...
class VideoCapabilityInstaller:
    ...
    def status(self) -> dict[str, object]:
        with self._lock:
            ...
            result = {
                ...
                "capability": "video",
                "can_uninstall": any(
                    child.name != "shared" for child in self.install_root.iterdir()
                ),
    ...
    def uninstall(self) -> str:
        ...
        with self._lock:
            ...
            managed_children = [
                child for child in install_root.iterdir() if child.name != "shared"
            ]
